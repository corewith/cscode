...
namespace EMMS.DAL
{
    ...
    public class Job
    {
        ...
        //增加一条数据
        public bool Add(EMMS.Model.Job model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        //更新一条数据
        public bool Update(EMMS.Model.Job model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update tb_job set ");
        ...
        //得到一个对象实体
        public EMMS.Model.Job GetModel(string no)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 no, name from tb_job ");
            strSql.Append("where no=@no ");
        ...
        //得到一个对象实体
        public EMMS.Model.Job DataRowToModel(DataRow row)
        {
            EMMS.Model.Job model = new Model.Job();
            if (row != null)
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(") as row,T.* from tb_job T ");
        ...
        //批量添加
        public int AddList(List<EMMS.Model.Job> modelList)
        {
            //List<String> SqlStrList = new List<String>();
            //Hashtable SqlStrList = new Hashtable();
            //foreach (EMMS.Model.Job model in modelList)
            //{
            //    StringBuilder strSql = new StringBuilder();
            //    strSql.Append("insert into tb_job( ");
            //    strSql.Append("no,name) ");
            ...
            {
                StringBuilder strSql = new StringBuilder();
                strSql.Append("insert into tb_job(no,name) values( '" + model.No + "','" + model.Name + "')");
