...
namespace EMMS.DAL
{
    ...
    public class WarehouseAttri
    {
        ...
        public bool Exists(string no)
        {
            ...
            strSql.Append("select count(1) from tb_warehouseAttri ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into tb_warehouseAttri( ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update tb_warehouseAttri set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from tb_warehouseAttri ");
            strSql.Append("where no=@no ");
            SqlParameter[] parameters = { new SqlParameter("@no",SqlDbType.VarChar,2)};
            parameters[0].Value = no;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 no, name from tb_warehouseAttri ");
            strSql.Append("where no=@no ");
        ...
        //得到一个对象实体
        public EMMS.Model.WarehouseAttri DataRowToModel(DataRow row)
        {
            EMMS.Model.WarehouseAttri model = new Model.WarehouseAttri();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append("from tb_warehouseAttri ");
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(") as row,T.* from tb_warehouseAttri T ");
        ...
        public int AddList(List<EMMS.Model.WarehouseAttri> modelList)
        {
            ...
            //foreach (EMMS.Model.WarehouseAttri model in modelList)
            //{
            //    StringBuilder strSql = new StringBuilder();
            //    strSql.Append("insert into tb_warehouseAttri( ");
            //    strSql.Append("no,name) ");
            ...
            {
                StringBuilder strSql = new StringBuilder();
                strSql.Append("insert into tb_warehouseAttri(no,name) values( '"+model.No+"','"+model.Name+"')");
